...
public class CalculateScore {
    ...
    public static int calcScore(int[] objects) {
        ...
        //switch-case Verzweigung ähnlich wie if-else Verzweigung
        //Der Wert hinter dem switch wird nacheinander mit den hinter
        //der Sprungmaske case aufgeführten Werte verglichen
